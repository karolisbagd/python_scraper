...
class Twitter(webdriver.Chrome):
    ...
    def tweet_results(self):
        tweet_text = self.find_element(
            By.CLASS_NAME, 'css-1dbjc4n').find_element(By.XPATH, "//div[@data-testid='tweetText']")
        return tweet_text
    ...
    '''def find_tweet(self):
        ...
        tweet_element = self.find_element(By.XPATH, "//div[@data-testid='tweetText']")
